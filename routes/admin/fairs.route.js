...
router.delete('/delete-student-agenda-item', fairsController.deleteStudentAgendaItem );
router.delete('/delete-chaperone-agenda-item/:i', fairsController.deleteChaperoneAgendaItem );
